...
export default function SentinelAdvantagePlusFeatures() {
  const tabs = [
    { id: 'power', title: 'Generator Power', icon: Fuel, content: <FeatureContent specs={features.power} /> },
    { id: 'integration', title: 'Military Integration', icon: Zap, content: <FeatureContent specs={features.integration} /> },
    { id: 'connectivity', title: 'Communications', icon: Wifi, content: <FeatureContent specs={features.connectivity} /> },

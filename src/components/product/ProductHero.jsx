...
import SpecSheetFormModal from "./SpecSheetFormModal";
      ...
      <section className="px-4 sm:px-6 lg:px-8 bg-black relative overflow-hidden min-h-screen flex items-end pb-20 pt-20">
          <div className="absolute inset-0">
               <div 
                  ...
                  style={{backgroundImage: "url('https://res.cloudinary.com/dl71jvny5/image/upload/v1755118472/DSC05269_qxxf3d.jpg')"}}
                />
